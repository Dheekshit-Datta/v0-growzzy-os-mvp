 ...
 */
export function getBusinessContextForWorkspace(workspaceId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (workspace === null || workspace === void 0 ? void 0 : workspace.websiteUrl) {
            try {
                // Fetch and summarize website content
                websiteSummary = yield summarizeWebsite(workspace.websiteUrl);
            }
            catch (error) {
 ...
 * @param workspaceId - The workspace ID
 */
export function invalidateBusinessContext(workspaceId) {
 ...
 */
export function refreshBusinessContext(workspaceId) {
    return __awaiter(this, void 0, void 0, function* () {
        invalidateBusinessContext(workspaceId);
        return yield getBusinessContextForWorkspace(workspaceId);
    });
}
/**
