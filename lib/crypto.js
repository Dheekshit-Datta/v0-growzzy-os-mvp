...
function getKey() {
    ...
    if (!key || key.length !== 64) {
        throw new Error('TOKEN_ENCRYPTION_KEY must be set to a 64-char hex string (32 bytes). Generate one with: node -e "console.log(require(\\"crypto\\").randomBytes(32).toString(\\"hex\\"))"');
    }
