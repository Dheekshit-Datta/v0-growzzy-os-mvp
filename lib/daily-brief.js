import { analyzeCampaigns, buildRuleRecommendations, calculateAccountAverages, calculateAuditScores, } from "@/lib/marketing-logic";
...
export function buildDailyBriefFromCampaigns(campaigns) {
...
export function enrichRecommendation(rec, campaigns) {
    const campaign = campaigns.find((item) => item.id === rec.campaignId);
    const spend = Number((campaign === null || campaign === void 0 ? void 0 : campaign.spend) || 0);
    const cpa = Number((campaign === null || campaign === void 0 ? void 0 : campaign.cpa) || 0);
    const cpc = Number((campaign === null || campaign === void 0 ? void 0 : campaign.cpc) || 0);
    const ctr = Number((campaign === null || campaign === void 0 ? void 0 : campaign.ctr) || 0);
    const campaignRoas = Number((campaign === null || campaign === void 0 ? void 0 : campaign.roas) || 0);
    const conversions = Number((campaign === null || campaign === void 0 ? void 0 : campaign.conversions) || 0);
    ...
    return Object.assign(Object.assign({}, rec), { spend,
        cpa,
        cpc,
        ctr, roas: campaignRoas, conversions,
        riskLevel,
        safeActionPayload, evidence: {
            spend: money(spend),
