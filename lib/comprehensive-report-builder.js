...
export class ComprehensiveReportBuilder {
    constructor(metrics, insights, actionPlan, reportId) {
        this.yPosition = 20;
        this.doc = new jsPDF();
    ...
    build() {
        ...
        this.doc.setFontSize(10);
        this.doc.setTextColor(100, 100, 100);
        this.doc.text(`${this.metrics.dateRange.from.toLocaleDateString()} - ${this.metrics.dateRange.to.toLocaleDateString()}`, this.pageWidth / 2, this.yPosition, { align: "center" });
        this.yPosition += 20;
        // Quick stats
        this.addMetricsGrid({
